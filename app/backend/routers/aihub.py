...
async def generate_text(
    ...
    Available models:
    - AI_DEFAULT_MODEL: high stability and compliance, suitable for JSON output and customer service scenarios
    - AI_DEFAULT_MODEL: production-grade multimodal model for daily multimodal tasks
    - AI_DEFAULT_MODEL: deep reasoning and ultra-long context (1M+ tokens)
    - AI_DEFAULT_MODEL: ideal for complex reasoning, engineering, and code generation
    """
    try:
...
async def generate_image(
    ...
    Available models:
    - AI_DEFAULT_MODEL: visual creativity and editing, marketing asset generation, partial image editing
    - AI_DEFAULT_MODEL: higher quality image generation/editing
