...
UNIFIED_JUDGMENT_STANDARD = UnifiedJudgmentStandard(
    ...
    root_layer={
        ...
        "level_0": [{"key": "gain", "label": "趋利"}, {"key": "loss", "label": "避害"}],
        "level_1": [{"key": "survival", "label": "生存"}, {"key": "reproduction", "label": "繁衍"}, {"key": "resource", "label": "资源"}, {"key": "exploration", "label": "探索"}],
        "motivation_nodes": [
    ...
    required_questions=(
        JudgmentQuestion("human_root", "这个购买行为背后是哪类趋利或避害驱动力？", "Level 0 gain/loss + Level 2 active human nodes"),
        JudgmentQuestion("motivation_path", "13个人性节点如何转成动机、需求、场景、解决方案和表达？", "Level 2 human nodes → Level 3 motivation → Level 4 need → Level 5 scenario → Level 6 solution → Level 7 expression"),
