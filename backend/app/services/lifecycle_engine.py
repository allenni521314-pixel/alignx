...
AD_STRATEGY: dict[str, dict] = {
    "new_product": {
        "budget": "$10-20/天",
        "acos_target": "30%",
        "keyword_strategy": "精准长尾词 + 自动广告探索",
        "bid_strategy": "固定竞价（Fixed bids），控制ACoS学习期",
        "focus": "获取首次出单数据，测试搜索词相关性",
    },
    "growth": {
        "budget": "$30-80/天",
        "acos_target": "25%",
        "keyword_strategy": "高转化词扩大 + 品牌词防守",
        "bid_strategy": "动态竞价-仅下调（Down only）",
        "focus": "放大已验证关键词，加速排名爬升",
    },
    "maturity": {
        "budget": "$50-150/天",
        "acos_target": "20%",
        "keyword_strategy": "品牌词+竞品词+防御词全覆盖",
        "bid_strategy": "动态竞价-上调和下调（Up & Down）",
        "focus": "利润最大化，防守竞品，收割长尾",
    },
    "decline": {
        "budget": "$5-20/天",
        "acos_target": "15%以内",
        "keyword_strategy": "仅保留高ROI词，停止扩量",
        "bid_strategy": "固定竞价（Fixed bids），严格控制成本",
        "focus": "降低广告依赖，转向自然流量维护",
    },
}
