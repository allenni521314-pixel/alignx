...
export const dictionaries: Record<Language, Dictionary> = {
  en: {
    ...
    "help.button": "Help",
    "help.title": "AlignX Help Assistant",
    "help.subtitle": "Ask about setup, data access, reports, billing or account support.",
    "help.placeholder": "Enter your question",
    "help.send": "Send",
    "help.sending": "Sending...",
    "help.close": "Close",
    "help.quickQuestions": "Quick questions",
    "help.createTicket": "Create Ticket",
    "help.ticketCreated": "Ticket created",
    "help.ticketFailed": "Failed to create ticket",
    "help.askFailed": "Failed to get answer",
    "help.uploadScreenshot": "Upload Screenshot",
    "help.policies": "Policies",
    "help.privacy": "Privacy Policy",
    "help.terms": "Terms of Service",
    "help.dataUse": "Data Use Policy",
    "help.security": "Security",
    "help.contact": "Contact",
    "help.ticketHint": "This issue can be handled by support ticket.",
    "help.issueType": "Issue Type",
    "help.priority": "Priority",
    "help.manualMessage": "Support ticket message",
    "help.quick.1": "How do I connect my Amazon seller data?",
    "help.quick.2": "What data does AlignX use?",
    "help.quick.3": "Does AlignX collect my Seller Central password?",
    "help.quick.4": "How do I upload advertising reports?",
    "help.quick.5": "How do I check an ASIN record?",
    "help.quick.6": "How do I contact support?",
  },
  zh: {
    ...
    "help.button": "帮助",
    "help.title": "AlignX 帮助助手",
    "help.subtitle": "可咨询系统设置、数据接入、报告说明、账单和账号支持。",
    "help.placeholder": "输入你的问题",
    "help.send": "发送",
    "help.sending": "发送中...",
    "help.close": "关闭",
    "help.quickQuestions": "快捷问题",
    "help.createTicket": "创建工单",
    "help.ticketCreated": "工单已创建",
    "help.ticketFailed": "创建工单失败",
    "help.askFailed": "获取回答失败",
    "help.uploadScreenshot": "上传截图",
    "help.policies": "政策链接",
    "help.privacy": "隐私政策",
    "help.terms": "用户协议",
    "help.dataUse": "数据使用政策",
    "help.security": "安全说明",
    "help.contact": "联系我们",
    "help.ticketHint": "这个问题可以创建客服工单处理。",
    "help.issueType": "问题类型",
    "help.priority": "优先级",
    "help.manualMessage": "工单内容",
    "help.quick.1": "如何连接 Amazon 卖家数据？",
    "help.quick.2": "AlignX 会使用哪些数据？",
    "help.quick.3": "AlignX 会收集 Seller Central 密码吗？",
    "help.quick.4": "如何上传广告报表？",
    "help.quick.5": "如何查看 ASIN 经营档案？",
    "help.quick.6": "如何联系人工客服？",
  },
};
